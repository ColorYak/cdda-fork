#pragma once
#ifndef GAUNTBAR_STORYBOOK_SHIMS_H
#define GAUNTBAR_STORYBOOK_SHIMS_H
...
// reads at runtime. Currently just sets `wide_pua_glyphs = true`
// (in-game wired through the `FONT_WIDE_PUA_GLYPHS` option) so Nerd
// Font PUA glyphs occupy two cells.
...
#endif // GAUNTBAR_STORYBOOK_SHIMS_H
